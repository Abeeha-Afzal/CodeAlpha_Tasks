...
public:
    ...
    int get_rollnum() { return roll_num; }
    double get_marks(int i) { return marks[i - 1]; }
    ...
    void set_roll(int r) { roll_num = r; }
    void set_marks(int n, double val) { marks[n - 1] = val; }
    void set_percent(float p) { percent = p; }
...
public:
    ...
    void display() {
        ...
        cout << "Practical Marks: " << practical << " / 150\n";
        cout << "Highest Mark: " << highest_mark() << endl;
    }
};

class ArtsStudent : public Student {
    double optional; // out of 100

public:
    ArtsStudent() : Student() {
        cout << "Enter Optional marks (out of 100): ";
        cin >> optional;
    }
    ...
    void display() {
        ...
        cout << "Optional Marks: " << optional << " / 100\n";
        cout << "Highest Mark: " << highest_mark() << endl;
    }
};
int main() {
